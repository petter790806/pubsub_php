...
class PshbPublisher {
  ...
  //hub_url->$url , post_string->$post_string
  private function http_post($url, $post_string) {
    ...
    $options = array(CURLOPT_URL => $url,
                     ...
                     CURLOPT_USERAGENT => "PubSubHubbub-Publisher-PHP/1.0"); //The contents of the "User-Agent: " header to be used in a HTTP request.
